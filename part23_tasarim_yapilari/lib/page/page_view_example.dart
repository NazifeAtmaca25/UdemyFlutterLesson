...
class _PageViewExampleState extends State<PageViewExample> {
  var myController=PageController(initialPage: 0,keepPage: true,viewportFraction: 1);//an object that allows you to control which page is visible in a PageView widget
    ...
    return Column(
      children: [
        Expanded(child: PageView(
          ...
          pageSnapping: pageSnapping,//bi anda diğer sayfaya geçmesini veya ekranı bıraktığımız yerde durmasını saülar
          onPageChanged: (index){
            ...
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Checkbox(value: yatayEksen, onChanged: (bool? c){
                      setState(() {
                        yatayEksen=c!;
                      });
                    })
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Page Snapping"),
                    Checkbox(value: pageSnapping, onChanged: (bool? c){
                      setState(() {
                        pageSnapping=c!;
                      });
                    })
              ...
              Row(
                children: [
                  ...
                  Checkbox(value: reverseSira, onChanged: (bool? c){
                    setState(() {
                      reverseSira=c!;
                    });
                  })
